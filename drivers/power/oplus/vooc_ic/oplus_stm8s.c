...
static bool stm8s_fw_check_frontline(struct oplus_vooc_chip *chip)
{
	...
	for (i = 0; i < READ_COUNT; i++) {	/*1508:448, 1503:192*/
		...
		if (addr == ((chip->firmware_data[fw_line * 34 + 1] << 8) |
				chip->firmware_data[fw_line * 34])) {
			for (j = 0; j < 32; j++) {
				if (data_buf[j] != chip->firmware_data[fw_line * 34 + 2 + j]) {
					...
					chg_err("addr = 0x%x, %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x "
						...
						data_buf[5], data_buf[6], data_buf[7],
						data_buf[8], data_buf[9], data_buf[10], data_buf[11], data_buf[12],
						data_buf[13], data_buf[14],
						data_buf[15], data_buf[16], data_buf[17], data_buf[18], data_buf[19],
						data_buf[20], data_buf[21], data_buf[22],
						data_buf[23], data_buf[24], data_buf[25], data_buf[26], data_buf[27],
						data_buf[28], data_buf[29], data_buf[30],
						data_buf[31]);
					return FW_CHECK_FAIL;
				}
			}
...
static int stm8s_fw_check_then_recover(struct oplus_vooc_chip *chip)
{
	...
	if (oplus_is_power_off_charging(chip) == true
		...
		if (stm8s_fw_check_frontline(chip) == FW_CHECK_FAIL
				|| stm8s_fw_check_lastline(chip) == FW_CHECK_FAIL) {
			do {
				update_result = stm8s_fw_update(chip);
			      ...
			      const struct i2c_device_id *id)
{
	...
	case VOOC_FW_TYPE_STM8S_4400_AVOID_FAKE_ADAPTER:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4400_avoid_fake_adapter[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_AVOID_FG_I2C_ERR:
		...
		chip->fw_data_version = Stm8s_fw_data_4400_avoid_fg_i2c_err[chip->fw_data_count
					- 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_AVOID_OVER_TEMP:
		...
		chip->fw_data_version = Stm8s_fw_data_4400_avoid_over_temp[chip->fw_data_count -
					4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_AVOID_OVER_TEMP_NTC61C:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4400_avoid_over_temp_ntc61c[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_VOOC_FFC_09C:
		...
		chip->fw_data_version = Stm8s_fw_data_4400_vooc_ffc_09c[chip->fw_data_count -
					4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_VOOC_FFC_15C:
		...
		chip->fw_data_version = Stm8s_fw_data_4400_vooc_ffc_15c[chip->fw_data_count -
					4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_VOOC_FFC_15C_FV4450:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4400_vooc_ffc_15c_fv4450[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_VOOC_FFC_15C_TI411:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4400_vooc_ffc_15c_ti411[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4450_FFC_5V6A_VOOC_4052MA_3BIT:
		...
		chip->fw_data_version = Stm8s_fw_data_4450_ffc_5v6a_3bit[chip->fw_data_count -
					4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4450_FFC_5V4A_VOOC_4052MA_3BIT:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4450_vooc_ffc_5v4a_3bit[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_VOOC_FFC_15C_18041:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4400_vooc_ffc_15c_18041[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4450_VOOC_FFC_5V6A_19365:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4450_VOOC_FFC_5V6A_19365[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4450_FFC_SHORT_RESET_WINDOW:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4450_ffc_ShortResetWindow[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_SVOOC_3500MA:
		...
		chip->fw_data_version = Stm8s_fw_data_4400_svooc_3500MA[chip->fw_data_count -
					4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_SVOOC_1000MA:
		...
		chip->fw_data_version = Stm8s_fw_data_4400_svooc_1000MA[chip->fw_data_count -
					4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_SVOOC_5000MA :
		...
		chip->fw_data_version = Stm8s_fw_data_4400_svooc_5000MA[chip->fw_data_count -
					4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_SVOOC_6500MA:
		...
		chip->fw_data_version = Stm8s_fw_data_4400_svooc_6500MA[chip->fw_data_count -
					4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4450_SVOOC_6500MA:
		...
		chip->fw_data_version = Stm8s_fw_data_4450_svooc_6500MA[chip->fw_data_count -
					4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4450_SVOOC_6500MA_FV4490:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4450_svooc_6500MA_fv4490[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4450_SVOOC_6500MA_disableI2C:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4450_svooc_6500MA_disableI2C[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_SVOOC_6500MA_8250:
		...
		chip->fw_data_version = Stm8s_fw_data_4400_svooc_6500MA_8250[chip->fw_data_count
					- 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4450_SVOOC_6500MA_8250:
		...
		chip->fw_data_version = Stm8s_fw_data_4450_svooc_6500MA_8250[chip->fw_data_count
					- 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_SVOOC_6500MA_8250_LINK:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4400_svooc_6500MA_8250_link[chip->fw_data_count - 4];
		break;
	...
	case VOOC_FW_TYPE_STM8S_4400_SVOOC_6500MA_8250_LINK_LITE:
		...
		chip->fw_data_version =
			Stm8s_fw_data_4400_svooc_6500MA_8250_link_lite[chip->fw_data_count - 4];
		break;
