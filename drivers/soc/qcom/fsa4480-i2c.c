...
struct fsa4480_priv {
	...
	int switch_control;
	#ifdef OPLUS_ARCH_EXTENDS
	/* add for type-c headphones cclogic sgm7220 notifiy */
	int is_audio_input;
	u32 use_cclogic_det;
	#endif /* OPLUS_ARCH_EXTENDS */
	#ifdef OPLUS_ARCH_EXTENDS
	/* 2022/04/09, Add for DIO4480 auto detect */
...
#ifdef OPLUS_ARCH_EXTENDS
		/* wenhuilong@MULTIMEDIA.AUDIODRIVER.CODEC, 2022/02/04, add for type-c headphones cclogic sgm7220 notifiy */
		if (fsa_priv->use_cclogic_det)
